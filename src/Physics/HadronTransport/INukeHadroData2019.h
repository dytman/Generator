...
#ifndef _INTRANUKE_HADRON_CROSS_SECTIONS_2019_H_
#define _INTRANUKE_HADRON_CROSS_SECTIONS_2019_H_
...
{
public:
  static INukeHadroData2019 * Instance (void);
...
private:
  INukeHadroData2019();
  INukeHadroData2019(const INukeHadroData2019 & shx);
 ~INukeHadroData2019();
  ...
  static INukeHadroData2019 * fInstance;
...
//  TGraph2D * TfracPipA_Elas;
  ...
  struct Cleaner {
      ...
      ~Cleaner() {
         if (INukeHadroData2019::fInstance !=0) {
            delete INukeHadroData2019::fInstance;
            INukeHadroData2019::fInstance = 0;
         }
      }
  };
...
#endif //_INTRANUKE_HADRON_CROSS_SECTIONS_2019_H_
