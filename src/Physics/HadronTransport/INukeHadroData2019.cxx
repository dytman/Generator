...
void INukeHadroData2019::LoadCrossSections(void)
{
  ...
  if (saveTGraphsToFile) {
    ...
    LOG("INukeHadroData2019", pNOTICE) << "Saving INTRANUKE hadron x-section data to ROOT file: " << filename;
...
//____________________________________________________________________________
double INukeHadroData2019::FracADep(int hpdgc, INukeFateHA_t fate, double ke, int targA) const
{
...
//____________________________________________________________________________
double INukeHadroData2019::FracAIndep(int hpdgc, INukeFateHA_t fate, double ke) const
{
  // return the x-section fraction for the input fate for the particle with the input pdg
